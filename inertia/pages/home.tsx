...
const MainHome = () => (
  <div className="overflow-x-hidden flex flex-col">
    ...
    >
      ...
      <Link
        to="/rsvp"
        className="mt-10 bg-purple-700 text-white px-8 py-4 rounded-full shadow-lg hover:bg-purple-800 transition duration-300"
      >
        RSVP Now
      </Link>
    </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen text-center p-2">
        <div className="bg-white p-8 rounded-2xl max-w-3xl flex flex-col items-center">
          ...
          <p className="text-lg text-gray-600 mb-6">
            ...
            person—it’s about discovering God’s perfect plan. Our journey together is a testament to
            His faithfulness, timing, and grace.
            <br /> <br />
            Every step we’ve taken has led us here, to a love that is deeper than words, rooted in
            faith, and strengthened by His promises. We are beyond grateful for this beautiful gift
            of love, knowing that our story was written long before we even met.
            <br /> <br />
