...
const MainHome = () => {
  ...
  return (
    <>
      <div
        className="overflow-x-hidden flex flex-col h-screen scroll-smooth snap-y snap-mandatory"
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="snap-start w-screen h-screen bg-gradient-to-r from-purple-50 to-indigo-100 md:flex md:items-center md:relative">
              {/* Image on the left */}
              <motion.div
                className="h-[50dvh] w-screen md:h-screen md:w-[70dvw] max-[412px]:h-[40dvh]" // 70% viewport width and 100% viewport height
              ...
              <motion.div
                className="w-screen h-[50dvh] md:absolute md:top-50 md:right-20 md:w-[45dvw] md:h-[70dvh] max-[412px]:h-[60dvh] flex flex-col items-center md:items-start justify-center text-center md:text-left p-6 sm:p-12 bg-white bg-opacity-90 rounded-md shadow-md"
                initial={{ opacity: 0, x: 50 }}
            ...
            <div className="snap-start w-screen h-screen bg-gradient-to-b from-purple-50 to-indigo-100 flex items-center justify-center text-center">
              <div className="w-screen h-screen flex flex-col items-center justify-center px-8">
                ...
                >
                  ...
                  <p className="max-[400px]:text-xs text-sm sm:text-lg text-gray-700 mb-6">
                    Please come dressed in <b>formal attire</b>. We can't wait to see you looking
                    your best!
                  </p>
                </motion.div>
                <motion.div
            ...
            <div className="snap-start w-screen h-screen">
              <div className="w-screen h-screen flex flex-col items-center justify-center text-center p-8">
                ...
                >
                  ...
                  <p className="max-[400px]:text-xs text-sm sm:text-lg text-gray-700">
                    Use the <b>Google Maps</b> below or open Waze for step-by-step directions
                    straight to our venue, <b>Crystal Palace of Aquila in the Sky</b>.
                  </p>
                </motion.div>
                <motion.div
