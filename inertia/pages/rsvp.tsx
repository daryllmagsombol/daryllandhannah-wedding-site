...
export default function RSVP() {
  ...
  return (
    <div className="max-w-lg mx-auto mt-12 p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
      <h2
        className="text-5xl font-extrabold mb-2 text-center text-blue-700 tracking-tight"
        style={{
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-blue-600 to-blue-400 text-white py-3 rounded-full font-bold text-lg shadow hover:from-blue-700 hover:to-blue-500 transition disabled:opacity-50"
