...
const endCatHappyGif =
  'https://media1.giphy.com/media/WsSB3qO2Dfwmc6jV6e/giphy.gif?cid=6c09b952tcbx37nv2h1b6qihjslu55d75jovzqb76tqzzs3b&ep=v1_stickers_search&rid=giphy.gif&ct=s'
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-fuchsia-200 to-white-400 text-center p-6">
      <div className="p-8 bg-white shadow-2xl rounded-3xl w-90 text-center border border-red-300">
        <h1 className="text-4xl font-extrabold mb-6 text-red-600">
          Hey Hannah, Will You Be My Valentine? ❤️
        </h1>
        {showMessage ? (
          <div className="flex flex-col items-center">
            <h2 className="text-2xl font-semibold text-gray-700">
              You selected <b>{selectedFood}</b> mahal! See you tomorrow in the morning! ☀️
            </h2>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button
                  onClick={() => handleFoodSelection('Chicken')}
                  className="w-full px-5 py-3 bg-red-500 text-white rounded-xl shadow-lg hover:bg-red-600"
                >
                  {' '}
                  🍗 Chicken
                </button>
              ...
              <li>
                <button
                  onClick={() => handleFoodSelection('Pizza')}
                  className="w-full px-5 py-3 bg-red-500 text-white rounded-xl shadow-lg hover:bg-red-600"
                >
                  🍕 Pizza
                </button>
              ...
              <li>
                <button
                  onClick={() => handleFoodSelection('Steak')}
                  className="w-full px-5 py-3 bg-red-500 text-white rounded-xl shadow-lg hover:bg-red-600"
                >
                  🥩 Steak
                </button>
              ...
              <li>
                <button
                  onClick={() => handleFoodSelection('Breakfast Buffet')}
                  className="w-full px-5 py-3 bg-red-500 text-white rounded-xl shadow-lg hover:bg-red-600"
                >
                  🍽️ Breakfast Buffet
                </button>
          ...
          <div className="flex flex-col items-center">
            <img
              src={gifs[gifIndex]}
              alt="Funny reaction"
              className="w-64 h-64 mt-6 rounded-2xl shadow-md border border-gray-300"
            />
            <motion.div whileHover={{ scale: 1.1 }}>
              <button
                onClick={() => setShowFoodOptions(true)}
                className="m-2 px-8 py-4 text-xl bg-red-500 text-white rounded-xl shadow-lg hover:bg-red-600"
              >
                Yes 💖
              </button>
            </motion.div>
            <motion.div whileHover={{ scale: 1.1 }}>
              <button
                ...
                className="m-2 px-8 py-4 text-xl bg-gray-500 text-white rounded-xl shadow-lg hover:bg-gray-600"
              >
                No 😢
              </button>
            </motion.div>
